...
ARG NEXT_PUBLIC_CASHIER_TENANT_DAY_REFRESH_MS
ARG NEXT_PUBLIC_STAFF_PAYMENT_HANDOFF_REFRESH_MS
ARG NEXT_PUBLIC_SERVER_ORDER_PAGE_SIZE
ARG NEXT_PUBLIC_SERVER_ORDER_MAX_PAGES
...
ENV NEXT_PUBLIC_CASHIER_TENANT_DAY_REFRESH_MS=${NEXT_PUBLIC_CASHIER_TENANT_DAY_REFRESH_MS}
ENV NEXT_PUBLIC_STAFF_PAYMENT_HANDOFF_REFRESH_MS=${NEXT_PUBLIC_STAFF_PAYMENT_HANDOFF_REFRESH_MS}
ENV NEXT_PUBLIC_SERVER_ORDER_PAGE_SIZE=${NEXT_PUBLIC_SERVER_ORDER_PAGE_SIZE}
ENV NEXT_PUBLIC_SERVER_ORDER_MAX_PAGES=${NEXT_PUBLIC_SERVER_ORDER_MAX_PAGES}
