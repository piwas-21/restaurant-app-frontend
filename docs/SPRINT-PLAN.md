...
|------|-------------|-------|------------|--------|
| `OrderDetailsModal.tsx` | 906 | 200 | 200 | Sprint 6 |
| `useCashierOrders.ts` | 688 | 200 | 100 | Sprint 6 |
| `orders-management/page.tsx` | 640 | 200 | 200 | Sprint 6 |
| `cashier/page.tsx` | 611 | 200 | 200 | Sprint 6 |
| `CustomerDiscountForm.tsx` | 597 | 250 | 150 | Sprint 6 |
| `reservations-management/page.tsx` | 556 | 200 | 200 | Sprint 6 |
| `serverService.ts` | 552 | 200 | 200 | Sprint 7 |
| `order-type/page.tsx` | 547 | 200 | 200 | Sprint 7 |
| `orders/page.tsx` | 507 | 200 | 200 | Sprint 7 |
| `useServerOrders.ts` | 483 | 200 | 150 | Sprint 7 |
| `useNotification.ts` | 483 | 200 | 150 | Sprint 7 |
| `table-layout-editor/page.tsx` | 482 | 200 | 200 | Sprint 7 |
| `CartContext.tsx` | 481 | 250 | 200 | Sprint 7 |
| `customer-info/page.tsx` | 465 | 200 | 200 | Sprint 7 |
| `TaxConfigurationManager.tsx` | 458 | 250 | 200 | Sprint 7 |
| `TakeOrderModal.tsx` | 456 | 200 | 200 | Sprint 7 |
| `checkout/confirmation/page.tsx` | 456 | 200 | 200 | Sprint 7 |
| `AddressManagement.tsx` | 455 | 250 | 200 | Sprint 7 |
| `OrderDetails.tsx` (cashier) | 448 | 250 | 200 | Sprint 5 |
| `ProductCustomizationInBundle.tsx` | 446 | 250 | 200 | Sprint 7 |
| `ProductIngredientsManager.tsx` | 423 | 250 | 200 | Sprint 7 |
| `types/order.ts` | 407 | 150 | 150 | Sprint 7 |
