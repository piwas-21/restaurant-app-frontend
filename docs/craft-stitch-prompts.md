...
| 6   | Checkout                                                   | 🚧 In progress (PR B: shell + bill summary)   | [`checkout_light_mode_desktop/`](stitch-screens/checkout_light_mode_desktop/) · [`_dark_mode_desktop/`](stitch-screens/checkout_dark_mode_desktop/)                                                                                        |
...
| 9   | Modal / dialog shell (BaseModal chrome)                    | ✅ Design ready (to implement)                | `BaseModal` (+ `AlertDialog`) — skinning the shell re-skins the 7 `BaseModal` customer modals at once. [`_light`](stitch-screens/modal_shell_light_mode/) · [`_dark`](stitch-screens/modal_shell_dark_mode/) |
