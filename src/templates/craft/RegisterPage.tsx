...
// craft RegisterPage (ADR-006 — Prompt 8). Same register behaviour as classic
// (via the shared `useRegisterForm` hook) composed as a craft welcome card, with
// a craft "you're in" success note. Reuses every existing auth i18n key; adds
// only the craft tape/subhead flavour keys.
  ...
  return (
    <main className={styles.authContainer}>
      <div className={styles.card}>
        ...
        <form className={styles.formSide} onSubmit={handleSubmit} noValidate>
