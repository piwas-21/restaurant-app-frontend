...
if (
  ...
  warn(
    'raw color outside design-system/tokens — use var(--*); color values live in src/design-system/tokens/ (S15 T1 ratchet)',
  );
...
if (
  ...
  !/\/(AdminOrdersPage|AdminPage|CashierPage|KitchenStaffPage|RegisterStaffModal|ServerPage)\.module\.css$/.test(
    file,
  ) &&
