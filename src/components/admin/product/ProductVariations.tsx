    ...
    <div className={modalStyles.formGroup}>
      ...
      {variationFields.map((field, index) => (
        <div key={field.id} className={modalStyles.variationItem}>
          <button type="button" className={modalStyles.cancelButton} onClick={() => removeVariation(index)}>
            {t('remove')}
          </button>
          <div className={modalStyles.formGroup}>
          ...
          <div className={modalStyles.formGroup}>
            ...
            <input type="number" step="0.01" {...register(`variations.${index}.priceModifier`)} />
          </div>
          <div className={modalStyles.formGroup}>
            <label>{t('display_order')}</label>
            <input type="number" {...register(`variations.${index}.displayOrder`)} />
          </div>

          {/* Multilingual Support */}
          <div className={modalStyles.formGroup}>
            <details className={ingredientStyles.translations}>
              <summary className={ingredientStyles.translationsSummary}>{t('multilingual_names')}</summary>
          ...
          <div className={modalStyles.chipGroup}>
            <div className={modalStyles.chip}>
              <input type="checkbox" id={`variation-active-${index}`} {...register(`variations.${index}.isActive`)} />
